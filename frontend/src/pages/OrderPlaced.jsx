...
function OrderPlaced() {
  ...
  return (
    ...
    text-center relative overflow-hidden'>
        ...
        <button onClick={()=> navigate("/my-orders")} className='bg-[#ff4d2d] hover:bg-[#e64526] text-white px-6 py-3 rounded-lg text-lg
        font-medium transition'>Back to my orders</button>
    </div>
  )
}
