...
function OwnerDashboard() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#fff9f6] flex flex-col items-center">
      {!myShopData && (
        <div className="flex justify-center bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 mb-4 text-sm sm:text-base">
              Join out food delivery platform and reach thousands of hungry customers every day.
            </p>
          ...
          </div>
          {
            ...
            <div className="flex justify-center bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <button onClick={() => navigate('/add-item')} className="bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-orange-600 transition-colors duration-200 cursor-pointer">
                  Add Food
                </button>
              </div>
            </div>
